...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-03-29T11:04:34.480Z',
    sentDate: '2022-03-29T03:17:37.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-03-28T19:22').should('have.value', '2022-03-28T19:22');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2022-03-28T19:27').should('have.value', '2022-03-28T19:27');
