...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2022-03-29T04:24:18.621Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'generation',
        date: '2022-03-29T09:50:16.046Z',
        details: 'Associate',
        status: 'PAID',
        paymentMethod: 'PAYPAL',
        paymentDate: '2022-03-29T03:16:31.870Z',
        paymentAmount: 13982,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-03-29T08:53').should('have.value', '2022-03-29T08:53');
