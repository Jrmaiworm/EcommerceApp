...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2022-03-29T04:32:05.907Z', status: 'COMPLETED', code: 'adapter capability Communications' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-03-29T13:39').should('have.value', '2022-03-29T13:39');
