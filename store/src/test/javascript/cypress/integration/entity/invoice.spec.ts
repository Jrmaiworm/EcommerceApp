...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    code: 'microchip',
    date: '2022-03-28T20:47:01.017Z',
    status: 'PAID',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-03-28T23:02:28.769Z',
    paymentAmount: 43049,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-03-29T04:00').should('have.value', '2022-03-29T04:00');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-03-28T21:28').should('have.value', '2022-03-28T21:28');
